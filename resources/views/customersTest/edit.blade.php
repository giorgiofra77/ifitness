...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header text-center fs-3">{{ __('Modifica PowerTest di ') . $test->customer->name . ' ' . $test->customer->lastname}}</div>

                <div class="card-body">

                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a class="btn btn-danger" href="{{route('test.show', $test->id)}}" role="button"><i class="bi bi-backspace me-2"></i>{{ __('messages.cancel') }}</a>
                    </div>
